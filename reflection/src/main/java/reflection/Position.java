package reflection;// reflection/reflection.Position.java
...
class Position {
  ...
  public void setTitle(String newTitle) {
    // Throws reflection.EmptyTitleException if newTitle is null:
  ...
  @Override public String toString() {
    return "reflection.Position: " + title +
      ", Employee: " + person;
  }
...
/* Output:
reflection.Position: CEO, Employee: <Empty>
reflection.Position: Programmer, Employee: Arthur Fonzarelli
